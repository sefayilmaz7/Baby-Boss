...
public static class DT
{
    ...
    {
        get { return mProjects.Values.ToList(); }
    }
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                if (array[i].Contains(editorPreferencesArraySeparator))
                    throw new ArgumentException(String.Format(
                        "value should not have any element containing a {0} character",
                        editorPreferencesArraySeparator));
            }
        ...
        if (EditorPrefs.HasKey(key))
        {
            ...
            try
            {
                ...
                else if (tt.IsArray)
                {
                    ...
                    return (T) (object) EditorPrefs.GetString(key, ((Color) (object) defaultValue).ToHtml())
                        .ColorFromHtml();
                else
                    DTLog.LogError("[DevTools] SetEditorPrefs: Unsupported datatype: " + tt.Name);
            }
