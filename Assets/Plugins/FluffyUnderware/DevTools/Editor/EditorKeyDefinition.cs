...
public class EditorKeyBinding : IComparable
{
    ...
    public EditorKeyBinding(string name, string description, KeyCode defKey = KeyCode.None, bool defShift = false,
        bool defControl = false, bool defAlt = false, bool defCommand = false,
        MouseButtonEnum defMouseButton = MouseButtonEnum.None)
    {
    ...
    public void Set(string name, string description, KeyCode defKey = KeyCode.None, bool defShift = false,
        bool defControl = false, bool defAlt = false, bool defCommand = false,
        MouseButtonEnum defMouseButton = MouseButtonEnum.None)
    {
        Name = name;
    ...
    {
        return Name + "," + ((int) Key).ToString() + "," + Shift.ToString() + "," + Control.ToString() + "," +
               Alt.ToString() + "," + Command.ToString() + "," + ((int) MouseButton).ToString();
    }
    ...
    {
        return Name.GetHashCode() ^ Key.GetHashCode() ^ Shift.GetHashCode() ^ Control.GetHashCode() ^
               Alt.GetHashCode() ^ Command.GetHashCode() ^ MouseButton.GetHashCode();
    }
}