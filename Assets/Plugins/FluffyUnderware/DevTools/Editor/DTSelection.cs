...
public static class DTSelection
{
    ...
    public static bool HasComponent<T>(bool allowMultiSelection = false) where T : Component
    {
        if (allowMultiSelection)
            ...
            return mCurrentGameObjectsCount == 1 && mCurrentGameObject != null &&
                   mCurrentGameObject.GetComponent(typeof(T)) != null;
    }
    ...
    {
        Object[] S = Selection.GetFiltered(typeof(T),
    ...
    {
        GameObject[] selectedGameObjects = Selection.gameObjects;
        if (!MuteEvents && Selection.activeGameObject != mCurrentGameObject ||
